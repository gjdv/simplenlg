...
namespace SimpleNLG.Main.features
{
	...
	public abstract class LexicalFeature
	{
	     ...
	     * </table>
	     */
		public const string ACRONYM_OF = "acronym_of";
	     ...
	     * </table>
	     */
		public const string ACRONYMS = "acronyms";
	     ...
	     * </table>
	     */
		public const string DEFAULT_INFL = "default_infl";
	     ...
	     * </table>
	     */
		public const string SPELL_VARS = "spell_vars";
	     ...
	     * </table>
	     */
		public const string DEFAULT_SPELL = "default_spell";
	     ...
	     * </table>
	     */
		public const string BASE_FORM = "base_form";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string DITRANSITIVE = "ditransitive";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string INTENSIFIER = "intensifier";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string PAST_PARTICIPLE = "pastParticiple";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string PREDICATIVE = "predicative";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string PRESENT_PARTICIPLE = "presentParticiple";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string PRESENT3S = "present3s";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string SENTENCE_MODIFIER = "sentence_modifier";
	    /**
	     * <p>
	     ...
	     * </table>
	     */
		public const string VERB_MODIFIER = "verb_modifier";
	     ...
	     * </table>
    	 */
		public const string EXPLETIVE_SUBJECT = "expletive_subject";
		...
		{
			if (cat.Equals(PhraseCategory.PhraseCategoryEnum.NOUN_PHRASE) || cat.Equals(LexicalCategory.LexicalCategoryEnum.NOUN))
			{
				return new string[] {PLURAL};
			}
			else if (cat.Equals(PhraseCategory.PhraseCategoryEnum.VERB_PHRASE) || cat.Equals(LexicalCategory.LexicalCategoryEnum.VERB))
			{
				return new string[] {PAST, PAST_PARTICIPLE, PRESENT_PARTICIPLE, PRESENT3S};
			}
			else if (cat.Equals(PhraseCategory.PhraseCategoryEnum.ADJECTIVE_PHRASE) || cat.Equals(LexicalCategory.LexicalCategoryEnum.ADJECTIVE))
			{
