...
namespace SimpleNLG.Main.aggregation
{
	...
	public abstract class PhraseChecker
	{
	     ...
	     */
		public static bool sameSentences(params NLGElement[] sentences)
		{
			bool equal = false;
	     ...
	     */
		public static bool expletiveSubjects(params NLGElement[] sentences)
		{
			bool expl = true;
	     ...
	     *         .
	     */
		public static bool sameFrontMods(params NLGElement[] sentences)
		{
			bool equal = true;
	     ...
	     */
		public static bool samePostMods(params NLGElement[] sentences)
		{
			bool equal = true;
			...
			if (sentences.Length >= 2)
			{
				...
				for (int i = 1; i < sentences.Length && equal; i++)
				{
					equal = sentences[i - 1].getFeatureAsElementList(InternalFeature.POSTMODIFIERS).Equals(sentences[i].getFeatureAsElementList(InternalFeature.POSTMODIFIERS));
				}
			}
	     ...
	     */
		public static bool sameSubjects(params NLGElement[] sentences)
		{
	     ...
	     */
		public static bool allPassive(params NLGElement[] sentences)
		{
			bool passive = true;
	     ...
	     */
		public static bool allActive(params NLGElement[] sentences)
		{
			bool active = true;
	     ...
	     */
		public static bool sameSurfaceSubjects(params NLGElement[] sentences)
		{
			return allActive(sentences) && sameSubjects(sentences) || allPassive(sentences);
	     ...
	     */
		public static bool haveSameVoice(params NLGElement[] sentences)
		{
			bool samePassive = true;
			bool prevIsPassive = false;
	     ...
	     */
		public static bool sameVP(params NLGElement[] sentences)
		{
			bool equal = sentences.Length >= 2;
	     ...
	     */
		public static bool sameVPArgs(params NLGElement[] sentences)
		{
			bool equal = sentences.Length >= 2;
	     ...
	     *         are found
	     */
		public static IList<PhraseSet> leftPeriphery(params NLGElement[] sentences)
		{
	     ...
	     */
		public static bool nonePassive(params NLGElement[] sentences)
		{
			bool nopass = true;
