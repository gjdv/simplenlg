...
namespace SimpleNLG.Main.framework
{
	...
	public abstract class NLGModule
	{
		...
		protected internal Lexicon lexicon = null;
	     ...
	     */
		public abstract IList<NLGElement> realise(IList<NLGElement> elements);

	    /**
	     * Set / get the lexicon to be used by this module. Passing in <code>null</code>
