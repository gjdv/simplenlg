...
namespace SimpleNLG.Main.framework
{
     ...
     * 
     */
    public class PhraseCategory : ElementCategory
    {
        ...
        private PhraseCategoryEnum _phraseCategory;
        public PhraseCategoryEnum GetPhraseCategory()
        {
            return _phraseCategory;
        }
        ...
        {
            return _phraseCategory.ToString();
        }
	    /**
	     * <p>
