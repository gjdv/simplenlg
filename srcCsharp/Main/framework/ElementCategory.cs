...
namespace SimpleNLG.Main.framework
{
	...
	public abstract class ElementCategory
	{
	     ...
	     *         otherwise.
	     */
		public abstract override bool Equals(object checkObject);

	    public static bool operator == (ElementCategory obj1, object obj2)
	    {
	        return ReferenceEquals(obj1, null) ? false : obj1.Equals(obj2);
	    }
