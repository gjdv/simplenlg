...
namespace SimpleNLG.Main.framework
{
     ...
     * 
     */
	public class LexicalCategory : ElementCategory
	{
	    public enum LexicalCategoryEnum
	    {
	    ...
	    private LexicalCategoryEnum _lexicalCategory;
	    public LexicalCategoryEnum GetLexicalCategory()
	    {
	        return _lexicalCategory;
	    }
	    public LexicalCategory(LexicalCategoryEnum lexicalCategory)
	    {
	        _lexicalCategory = lexicalCategory;
	    }

	    public override string ToString()
	    {
	        return _lexicalCategory.ToString();
	    }
