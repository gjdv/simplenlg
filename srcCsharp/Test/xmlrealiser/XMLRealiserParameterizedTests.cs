...
namespace SimpleNLG.Test.xmlrealiser
{
    using LexiconType = XMLRealiser.LexiconType;
    using DocumentRealisation = DocumentRealisation;
    ...
    public class XMLRealiserParameterizedTests
    {
        ...
        internal XmlDocumentElement testElement;
        ...
        public static ICollection<object[]> Test
        {
            get
            {
                List<object[]> tests = new List<object[]>();

                tests.AddRange(testRecordings(clauseTest));
                tests.AddRange(testRecordings(AppositiveTest));
                tests.AddRange(testRecordings(aProblemTest));
                tests.AddRange(testRecordings(CoordPhraseNegationTest));
                tests.AddRange(testRecordings(CoordPhraseTest));
                tests.AddRange(testRecordings(docExamplesTest));
                tests.AddRange(testRecordings(lexicalVarTest));
                tests.AddRange(testRecordings(npTest));
                tests.AddRange(testRecordings(singleTest));
                tests.AddRange(testRecordings(someTest));
        ...
        public virtual void performTest()
        {
            ...
            catch (XMLRealiserException)
            {
                Assert.Fail("Error processing XmlDocumentElement");
            }

            Assert.AreEqual(failMessage, expectedResult, realisation.Trim());
        }

        internal static ICollection<object[]> testRecordings(string recording)
        {
            ICollection<object[]> tests = new List<object[]>();
            object[] testElement;
            ...
            {
                Assert.Fail("Error parsing test xml: " + " " + e.Message);
            }
            finally
            {
                reader.Close();
            ...
            foreach (DocumentRealisation test in records.Record)
            {
                testElement = new object[3];
                testElement[0] = test.Document;
                testElement[1] = test.Realisation.Trim();
                testElement[2] = string.Format("Test :<{0}>", test.Name);
        ...
        internal static string AppositiveTest = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
        ...
        internal static string aProblemTest =
        ...
        internal static string clauseTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
            "  <Recording name=\"Clause tests\">\r\n" +
            "    <Record name=\"Negation on VP\">\r\n" +
            "      <Document cat=\"PARAGRAPH\">\r\n" +
        ...
        internal static string CoordPhraseNegationTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
        ...
        internal static string CoordPhraseTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
            "  <Recording name=\"\">\r\n" +
            "    <Record name=\"\">\r\n" +
            "      <Document cat=\"PARAGRAPH\">\r\n" +
        ...
        internal static string docExamplesTest = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\r\n" +
        ...
        internal static string lexicalVarTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
        ...
        internal static string singleTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
            "  <Recording name=\"Clause tests\">\r\n" +
            "    <Record name=\"Interrogative WH Object\">\r\n" +
            "      <Document cat=\"PARAGRAPH\">\r\n" +
        ...
        internal static string someTest =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><NLGSpec xmlns=\"http://simplenlg.googlecode.com/svn/trunk/res/xml\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" +
